...
source("../Scripts/Fun_CIBERSORT.R")
...
run.CIB <- function(directoryCIB = paste0(root.dir, "Data/Preprocessed/CIB/"), mixString, sigString = FALSE, sigObject = FALSE, from.file = TRUE) {
  # deconvolve
  if (from.file) {
